...
var closeThemeBox, dark_theme, dark_tooth, elProp, emacsColors, fromEmacsColor, getColor, getConfigColorTheme, getConfigDeftheme, importThemeHandler, light_theme, live_theme, loadConfig, master_table, setColor, setTheme, themes;
...
getColor = function(k) {
  return $(master_table[k].el[0]).css(elProp(k));
};
...
closeThemeBox = function() {
  return $('#config').fadeOut('fast', function() {
    $('.confarea').remove();
    $('.msg').remove();
    $('#config br').remove();
...
$(function() {
  ...
  $('#generate').click(function() {
    var confname, deftheme, txt;
    $('#generate').attr('disabled', 'disabled');
    $('#generate').blur();
    txt = "<a id=\"close\" href=\"#\" style=\"float:right\">Close [Esc]</a>";
    confname = $('#configname').val();
