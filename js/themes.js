...
var App, closeThemeBox, darkBooth, darkTheme, elp, emacsColors, fromEmacsColor, generateDeftheme, getColor, getFaceList, importThemeHandler, lightTheme, loadConfig, masterKeys, removeTheme, saveCurrentTheme, saveToLocalStorage, setColor, setTheme, setUndoKey, setUndoLive, themeGenerator, themes, undo, undoTheme, updateUserThemes, userThemes;
...
loadConfig = function(conf) {
  ...
  $('#theme-name').val(name);
  o = {};
  _.each(_.keys(App.faceTable), function(k) {
    var r;
...
fromEmacsColor = function(color, defaultColor) {
  if (color) {
