...
var App, abstractGenerator, closeThemeBox, code_spans, dark_theme, dark_tooth, elp, emacsColors, fromEmacsColor, generateColorTheme, generateDeftheme, getColor, importThemeHandler, light_theme, loadConfig, masterKeys, removeTheme, saveToLocalStorage, setColor, setTheme, setUndoKey, setUndoLive, themeGenerator, themes, undo, undo_theme, updateUserThemes, user_themes;
...
abstractGenerator = function(name, template, ctx) {
  return $.get(template).then(function(t) {
    var compiled, o;
    o = _.extend({
      name: name
    }, ctx);
